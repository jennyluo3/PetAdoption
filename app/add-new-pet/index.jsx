...
export default function AddNewPet() {
    ...
    const UploadImage=async()=>{
        try {
            ...
            // For web platform, use base64 storage to avoid CORS issues completely
            if (Platform.OS === 'web') {
                console.log('Using base64 storage for web platform...');
            ...
            // For native platforms, use Firebase Storage
            console.log('Using Firebase Storage for native platform...');
            ...
            const uploadPromise = async () => {
                ...
                console.log('Image blob created, size:', blobImage.size);
